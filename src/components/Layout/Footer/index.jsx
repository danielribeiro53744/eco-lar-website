    ...
    <footer className={`${classText ? classText : ""}`}>
      <div className="container">
        <div className="row">
          ...
          <div className="col-lg-3" >
            <div className="item md-mb50" id="pagesFooter">
              <div className="title" style={{ marginTop: '9%' }}>
              <h6 style={{ color: '#b19777' }}>{t("Global.pages")}</h6>
              </div>
              <ol style={{ textAlign: 'center', marginLeft: '20%' }}>
                <li>
              ...
              <ul>
                <li>
                  ...
                  <div className="cont">
                    ...
                    <p> Eco-lar, 571 A, Quatro Estradas, 8125-018, Quarteira</p>
